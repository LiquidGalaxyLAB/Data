...
Once your app has been added to the data repository and is available in the Liquid Galaxy LAB App Store:

1. Go to [Liquid Galaxy LAB App Store](https://store.liquidgalaxy.eu/).
2. Find your app in the store and click on it to open its details.
3. Click the **Share** button next to your app.
4. Copy the generated link and use it when sharing your app on social media, documentation, websites, or anywhere else.

Always use the link generated by the **Share** button so that users are directed to the correct app page in the store.
